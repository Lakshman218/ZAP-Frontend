...
function SideNavBar() {
  return (
    // <div class="w-full max-w-xs block justify-end">
      <div class="w-full max-w-72 block justify-end p-2">
      ...
      <aside id="logo-sidebar" class="p-4 ml-2 fixed top-0 left-0 z-40 w-72 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div class="rounded-lg h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
