...
function EditProfile({closeEditProfile}) {
  ...
  return (
    <div >
      ...
      onClose={closeEditProfile} // Close the modal and update the state in the parent component
    ...
    >
      ...
      <Modal.Body>
        ...
        <form className="max-w-md mx-auto">
          ...
          <div className="relative z-0 w-full mb-5 group">
              <input type="text" name="bio" id="bio" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
      ...
      <Modal.Footer>
        <Button color="gray" onClick={closeEditProfile}>
          Cancel
        </Button>
      </Modal.Footer>
      </div>
