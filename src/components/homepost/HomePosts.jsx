...
function HomePosts({post}) {
  ...
  return (
    ...
    <div className="w-full px-10 mb-8 mr-2 h-max rounded-md bg-black">
      ...
      <div className='flex justify-start items-center'>
        ...
        <div className='ml-4 font-medium text-lg mb-2'>
      ...
      <div className=" p-4"> 
        ...
        <svg className="w-6 h-6 text-gray-200 darktext-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 20 22">
          <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12.01 6.001C6.5 1 1 8 5.782 13.001L12.011 20l6.23-7C23 8 17.5 1 12.01 6.002Z"/>
        </svg>

        <svg className="w-6 h-6 text-gray-200 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 20 22">
        ...
        <div className='text-gray-200 block py-2'>
          <p>{postTitle}</p>
